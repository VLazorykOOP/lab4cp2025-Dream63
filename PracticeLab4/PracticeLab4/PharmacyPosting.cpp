...
System::Void PharmacyPosting::button1_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	try
	{
		String^ connectstr = "Server=localhost\\SQLEXPRESS;Database=pharmacy_db;Trusted_Connection=True;";
		SqlConnection^ con = gcnew SqlConnection(connectstr);
		String^ sqlquery = "INSERT INTO Products (Type, Grade, Material, Supplier, ExpirationDate, Price) "
...
void PharmacyPosting::ClearFields()
{
	textBox1->Clear();
	textBox2->Clear();
	textBox3->Clear();
